            ...
            <Section>
                ...
                <SubItem>
                    ...
                    <Subtext variant="h6" component="div">
                        they’re interested in new, deeper ways to connect with
                        their favorite streamers beyond passive viewership
                    </Subtext>
                </SubItem>
                <SubItem>
            ...
            <Section>
                ...
                <SubItem>
                    ...
                    <Subtext
                        ...
                        style={{ margin: "18px 0px" }}
                    >
                        We believe that <b>more native gaming experiences</b>
                        --designed specifically for how streamers and viewers
                        can connect on-stream--will better serve that magic.
                    </Subtext>
                    <Subtext
                        variant="h6"
                        component="div"
                        style={{ margin: "18px 0px" }}
                    >
                        <b>Chat Jump</b> is our first prototype in a suite of
                        new games to bring streamers and viewers closer
                        together.
                    </Subtext>
                </SubItem>
            </Section>
