export default class MessagePlatform extends Phaser.GameObjects.Text {
	...
	setUp() {
		...
		this.setY(Math.min(this.scene.player.y + 200 - 800 * Math.random(), Math.random() * 150 + -300));
		this.body.setVelocityX(this.direction * (this.BASE_MOVE_SPEED + Math.random() * this.MOVE_SPEED_RANGE));
